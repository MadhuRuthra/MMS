...
for($ij = 0; $ij < count($date); $ij++) {
  ...
  $vlu_dt[$ij][0] = $this_date;
        $vlu_dt[$ij][1] = $this_date;
        $vlu_dt[$ij][2] = $this_date;
        $vlu_dt[$ij][3] = $this_date;
        $vlu_dt[$ij][4] = $this_date;
        $vlu_dt[$ij][5] = $this_date;
        $vlu_dt[$ij][6] = $this_date;
        $vlu_dt[$ij][7] = $this_date;
        $vlu_dt[$ij][8] = $this_date;
        $vlu_dt[$ij][9] = $this_date;
        $vlu_dt[$ij][10] = $this_date;
        $vlu_dt[$ij][11] = $this_date;
        $vlu_dt[$ij][12] = $this_date;
        $vlu_dt[$ij][13] = $this_date;
        $vlu_dt[$ij][14] = $this_date;
        $vlu_dt[$ij][15] = $this_date;
        $vlu_dt[$ij][16] = $this_date;
        $vlu_dt[$ij][17] = $this_date;
        $vlu_dt[$ij][18] = $this_date;
        $vlu_dt[$ij][19] = $this_date;
        $vlu_dt[$ij][20] = $this_date;
        $vlu_dt[$ij][21] = $this_date;
        $vlu_dt[$ij][22] = $this_date;
        $vlu_dt[$ij][23] = $this_date;
	...
	if($create_query != '') {
        ...
        // [0, 0, 0], [0, 1, 1], [0, 2, 3], [0, 3, 4], [0, 4, 5], [0, 5, 0], [0, 6, 10], [0, 7, 0], [0, 8, 0], [0, 9, 0], [0, 10, 0], [0, 11, 0], [0, 12, 0], [0, 13, 0], [0, 14, 0], [0, 15, 0], [0, 16, 0], [0, 17, 0], [0, 18, 0], [0, 19, 0], [0, 20, 0], [0, 21, 0], [0, 22, 0], [0, 23, 0], [0, 24, 0], [0, 25, 0], [0, 26, 0], [0, 27, 0], [0, 28, 0], [0, 29, 0], [0, 30, 0]
				// echo "<Br>!!CAME!!".$ii."!!";
        $vlu[$ij][0] = $response1->cnt_visitor_0;
        $vlu[$ij][1] = $response1->cnt_visitor_1;
        $vlu[$ij][2] = $response1->cnt_visitor_2;
        $vlu[$ij][3] = $response1->cnt_visitor_3;
        $vlu[$ij][4] = $response1->cnt_visitor_4;
        $vlu[$ij][5] = $response1->cnt_visitor_5;
        $vlu[$ij][6] = $response1->cnt_visitor_6;
        $vlu[$ij][7] = $response1->cnt_visitor_7;
        $vlu[$ij][8] = $response1->cnt_visitor_8;
        $vlu[$ij][9] = $response1->cnt_visitor_9;
        $vlu[$ij][10] = $response1->cnt_visitor_10;
        $vlu[$ij][11] = $response1->cnt_visitor_11;
        $vlu[$ij][12] = $response1->cnt_visitor_12;
        $vlu[$ij][13] = $response1->cnt_visitor_13;
        $vlu[$ij][14] = $response1->cnt_visitor_14;
        $vlu[$ij][15] = $response1->cnt_visitor_15;
        $vlu[$ij][16] = $response1->cnt_visitor_16;
        $vlu[$ij][17] = $response1->cnt_visitor_17;
        $vlu[$ij][18] = $response1->cnt_visitor_18;
        $vlu[$ij][19] = $response1->cnt_visitor_19;
        $vlu[$ij][20] = $response1->cnt_visitor_20;
        $vlu[$ij][21] = $response1->cnt_visitor_21;
        $vlu[$ij][22] = $response1->cnt_visitor_22;
        $vlu[$ij][23] = $response1->cnt_visitor_23;
				...
				// echo "<br>==".$ii."==".$ij."==".$cnt_visitor_tmp."==".$visitor_cnt."((".$response1->visitor_list_entdate."))";
				// $visitor_cnt		.= "[".$ii.", ".$ij.", ".$cnt_visitor_tmp."], ";
...
for($inner_vlui = 0; $inner_vlui < 24; $inner_vlui++) {
  for($vlui = 0; $vlui < count($vlu); $vlui++) {
    // echo "<br>!!".$vlui."!!".$inner_vlui."!!".$vlu[$vlui][$inner_vlui]."!!";
    $final_display .= "[".$inner_vlui.", ".$vlui.", ".$vlu[$vlui][$inner_vlui]."], ";
    // $final_display1 .= "{ x: '".$inner_vlui."', y: '".$vlui."', heat: ".$vlu[$vlui][$inner_vlui]." }, ";
...
// }
// echo $create_query; 
// echo "br>++".$date_cnt = rtrim($date_cnt, ", ");
