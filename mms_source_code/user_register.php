...
>
  <head>
    ...
    <title>User Registration : <?=$site_title?></title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Home /</span> User Registration</h4>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST" onsubmit="return false" name="formAccountSettings">
                        <div class="row">
                          <div class="mb-4 col-md-4" style='visibility: hidden;'>
                            <div class="card-body">
                ...
                <input type="hidden" class="form-control" name='otp_call_function' id='otp_call_function'
                            ...
                            <div class="row">
                              ...
                              <div class="mb-9 col-md-9">
                                ...
                                <input class="form-control" type="email" id="txt_user_email" name="txt_user_email" value="" placeholder="Email Id" data-placement="top" tabindex="4" title="Email" />
